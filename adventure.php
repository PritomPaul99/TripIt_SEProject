...
<body>
   ...
   <div class="heading" style="background:url(images/adventure_1.png) no-repeat">
      <h1 style="text-decoration: black;">Adventure</h1>
   </div>
   ...
   <section class="reviews">
      ...
      <p style="text-align: center; font-size: large;">If you are an adventurer, you are at exactly right place! We will guide you to the right adventurous
         destination that matches your interest.</p>
   ...
   <!-- map start -->
   <section class="reviews">
      <h1 class="heading-title"> Top Adventure Destinations </h1>
      <div class="swiper reviews-slider">
         <div class="swiper-wrapper">
            ...
            <div class="swiper-slide slide">
               ...
               <span>Nature and Adventure</span>
               <!-- <img src="images/pic-4.png" alt=""> -->
            </div>
         </div>
      </div>
   ...
   <section class="reviews">
      <h2 style="text-align: center; font-size: x-large;"><b>For more information, visit<br><a href="package_1.php" class="btn">Packages</a></b></h2>
   </section>
